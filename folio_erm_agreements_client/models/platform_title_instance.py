...
T = TypeVar("T", bound="PlatformTitleInstance")


@attr.s(auto_attribs=True)
class PlatformTitleInstance:
    """
    Attributes:
        platform (Platform):
        title_instance (TitleInstance):
        id (Union[Unset, str]):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        title_instance = self.title_instance.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        title_instance = TitleInstance.from_dict(d.pop("titleInstance"))
        ...
        platform_title_instance = cls(
            platform=platform,
            title_instance=title_instance,
            id=id,
            class_=class_,
            coverage=coverage,
        ...
        platform_title_instance.additional_properties = d
        return platform_title_instance
