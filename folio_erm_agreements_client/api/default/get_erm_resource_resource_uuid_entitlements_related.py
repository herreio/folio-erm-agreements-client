...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/erm/resource/{resourceUUID}/entitlements/related".format(client.base_url, resourceUUID=resource_uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Returns list of entitlements (agreement lines) which offer access to the same title as the specified
    resource but on other platform-package combinations. Will return 404 for any resources other than
    PCIs and PTIs
    ...
    Returns:
        Response[Union[Any, Union['Results', List[Union['Agreement', 'CustomProperty', 'Entitlement', 'EntitlementOption', 'ErmResource', 'InternalContact', 'Job', 'Kb', 'LogEntry', 'Organisation', 'Package', 'PackageContentItem', 'RefData', 'RefDataCategory', 'StringTemplate']]]]]
    """
