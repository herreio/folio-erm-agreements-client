...
from ...models.get_erm_jobs_job_uuid_log_type_log_type import GetErmJobsJobUUIDLogTypeLogType
...
def _get_kwargs(
    job_uuid: str,
    log_type: GetErmJobsJobUUIDLogTypeLogType,
    *,
    client: Client,
    filters: str,
    match: str,
    ...
    url = "{}/erm/jobs/{jobUUID}/{logType}".format(client.base_url, jobUUID=job_uuid, logType=log_type)
