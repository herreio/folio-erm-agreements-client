...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/erm/resource/{resourceUUID}/entitlementOptions".format(client.base_url, resourceUUID=resource_uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Returns list of entitlement options (ways of acquiring) the specified resource
