...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/erm/sas/{agreementUUID}/resources/current".format(client.base_url, agreementUUID=agreement_uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Returns resources in the internal KB associated with specified agreement actively part of the
