...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/erm/packages/{packageUUID}/content/current".format(client.base_url, packageUUID=package_uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Returns resources in the internal KB associated with a particular package part of the package on the
    current date
