...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/erm/sas/{agreementUUID}/resources/export".format(client.base_url, agreementUUID=agreement_uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Export a list of all resources in the internal KB associated with specified agreement as JSON
