...
from ...models.get_erm_entity_type_entity_uuid_entity_type import GetErmEntityTypeEntityUUIDEntityType
...
def _get_kwargs(
    entity_type: GetErmEntityTypeEntityUUIDEntityType,
    entity_uuid: str,
    *,
    client: Client,
    x_okapi_tenant: str,
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[HttpError, Union['Agreement', 'CustomProperty', 'Entitlement', 'EntitlementOption', 'ErmResource', 'InternalContact', 'Job', 'Kb', 'LogEntry', 'Organisation', 'Package', 'PackageContentItem', 'RefData', 'RefDataCategory', 'StringTemplate']]]
    """
