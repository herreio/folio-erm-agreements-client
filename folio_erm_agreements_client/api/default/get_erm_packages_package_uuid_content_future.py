...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/erm/packages/{packageUUID}/content/future".format(client.base_url, packageUUID=package_uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Returns resources in the internal KB associated with a particular package which will become part of
