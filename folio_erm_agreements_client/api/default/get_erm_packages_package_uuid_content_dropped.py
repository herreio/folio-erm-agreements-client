...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/erm/packages/{packageUUID}/content/dropped".format(client.base_url, packageUUID=package_uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Returns resources in the internal KB associated with a particular package which were part of the
    package in the past
