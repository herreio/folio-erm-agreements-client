...
from ...models.get_erm_jobs_type_job_type_job_type import GetErmJobsTypeJobTypeJobType
...
def _get_kwargs(
    job_type: GetErmJobsTypeJobTypeJobType,
    *,
    client: Client,
    filters: str,
    match: str,
    ...
    url = "{}/erm/jobs/type/{jobType}".format(client.base_url, jobType=job_type)
...
def sync_detailed(
    ...
    *,
    ...
    """Returns list of jobs with specified type
