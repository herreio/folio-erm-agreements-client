...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/erm/resource/{resourceUUID}/entitlements".format(client.base_url, resourceUUID=resource_uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Returns list of entitlements (agreement lines) which include the resource directly or indirectly
    (e.g. as part of a package)
