...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/erm/sas/{agreementUUID}/resources/dropped".format(client.base_url, agreementUUID=agreement_uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Returns resources in the internal KB associated with specified agreement which were actively part of
    the agreement in the past
